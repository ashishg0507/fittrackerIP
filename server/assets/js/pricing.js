...
async function processPayment() {
    ...
    try {
        ...
        if (response.status === 401) {
            showNotification('Please sign in to continue with payment', 'error');
            closeModal();
            setTimeout(() => {
        ...
        showPaymentSuccess();
                    ...
                    buttonText.textContent = `Pay ₹${isYearly ? planData[selectedPlan].yearlyPrice : planData[selectedPlan].monthlyPrice}`;
                }
            },
            prefill: {
...
function showPaymentSuccess() {
    ...
    modalContent.innerHTML = `
        <div style="text-align: center; padding: 40px;">
            ...
            <button class="btn-primary" onclick="window.location.href='/'" style="margin-right: 10px;">
