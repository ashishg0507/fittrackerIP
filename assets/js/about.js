...
// Add ripple effect to any buttons
...
// Add floating animation to the main image
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (imagePlaceholder) {
        ...
        setInterval(() => {
            ...
            imagePlaceholder.style.transform = `translate(${randomX}px, ${randomY}px)`;
        }, 3000);
    }
});

// Add pulse effect to feature icons on hover
document.addEventListener('DOMContentLoaded', () => {
